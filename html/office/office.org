...
,#+HTML_HEAD: <!-- The loading of KaTeX is deferred to speed up page rendering -->
...
,#+HTML_HEAD: <!-- To automatically render math in text elements, include the auto-render extension: -->
,#+HTML_HEAD: <script defer
